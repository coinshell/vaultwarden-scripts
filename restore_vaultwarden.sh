...
# Copyright (c) 2025 coinshell
# 权限：自由使用、复制、修改、合并、发布、销售，需保留本声明。
set -euo pipefail
umask 077
# ========== 镜像摘要（先用假值占位，改成真实值） ==========
VAULTWARDEN_DIGEST="sha256:e81ca01351ecf40083366202b163e7a31abca04d96e2194e9e1f78a57052f65c"
CADDY_DIGEST="sha256:af32e97399febea808609119bb21544d0265c58a02836576e32a2d082c262c17"
...
gen_compose(){
  # ★ 新增：镜像完整性校验
  verify_image_digest "vaultwarden/server:1.33.0" "$VAULTWARDEN_DIGEST"
  verify_image_digest "caddy:2.8.4-alpine" "$CADDY_DIGEST"
